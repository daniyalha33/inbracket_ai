...
from .basic_operators import _eps
from .blocks import *
...
class MultiHead(nn.Module):
    ...
    def upsample(self, stage_n, stage_i, stage_list):
        ...
        x = pointops.interpolation(p, p0, x, batch_size, num_samples=1)
        return x
...
class ContrastHead(nn.Module):
    ...
    def sample_label(self, n, i, stage_list, target):
        ...
        batch_size = o.shape[0]
        neighbor_idx = pointops.knnquery_gpu(p, p, batch_size, nsample)  # (m, nsample)
        # exclude self-loop
        nsample -= 1
